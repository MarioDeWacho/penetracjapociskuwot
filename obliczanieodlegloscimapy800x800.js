// Funkcja licząca odległość między czołgami na mapach o wymiarach 800 x 800
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeModal(modalId) {
        ...
        function calculateDistance(p1, p2) {
            const dx = (p2.x - p1.x) * (800 / imageContainer.clientWidth);
            const dy = (p2.y - p1.y) * (800 / imageContainer.clientHeight);
    ...
    ['ustawOdlegloscLakeville', 'ustawOdlegloscMines', 'ustawOdlegloscRuinberg'].forEach(modalId => {
